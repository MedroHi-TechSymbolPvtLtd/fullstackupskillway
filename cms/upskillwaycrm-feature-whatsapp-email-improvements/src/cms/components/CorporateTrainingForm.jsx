...
const CorporateTrainingForm = ({ program, onSave, onCancel, mode = 'create' }) => {
  ...
  useEffect(() => {
    if (mode === 'edit' && program) {
      setFormData({
        ...
        videoDemoUrl: program.videoDemoUrl || '',
        tags: program.tags || [],
        price: program.price || '',
        status: program.status || 'draft',
        trainingType: program.trainingType || 'corporate',
        ...
        durationSummary: program.durationSummary || '',
        timelineSummary: program.timelineSummary || '',
        testimonialHighlight: program.testimonialHighlight || '',
        skills: program.skills || [],
        masteredTools: program.masteredTools || [],
        curriculum: Array.isArray(program.curriculum) ? program.curriculum : (program.curriculum?.modules || []),
    ...
    <div className="w-full bg-white rounded-lg shadow-lg border">
      <div className="p-6 border-b">
        <h2 className="text-2xl font-bold">
          {mode === 'create' ? 'Add New Training Program' : 'Edit Training Program'}
        </h2>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g., November 2025, 200 hours"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                placeholder="Single quote/summary to highlight"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
